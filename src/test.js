...
/*O componente Person e Message vai ser renderizado aqui*/
function Greeting() {
  return (
    <div>
      <Person />
...
//Não precisa escrever return porque em arrow function é implicito
const Person = () => <h2>John Doe</h2>;

const Message = () => <p>This is the person's name</p>;
